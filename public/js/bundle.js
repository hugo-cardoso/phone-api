...
},{"./controller/AppController":3}],3:[function(require,module,exports){
'use strict';
...
var _AppService = require('../service/AppService');

var _AppService2 = _interopRequireDefault(_AppService);

var _DeviceModel = require('../model/DeviceModel');

var _DeviceModel2 = _interopRequireDefault(_DeviceModel);

var _DeviceListView = require('../view/DeviceListView');

var _DeviceListView2 = _interopRequireDefault(_DeviceListView);

var _DeviceListModel = require('../model/DeviceListModel');

var _DeviceListModel2 = _interopRequireDefault(_DeviceListModel);
...
var AppController = function () {
  function AppController() {
    ...
    this.appService = new _AppService2.default();
    this.deviceListView = new _DeviceListView2.default('#tableContent');
    this.deviceListModel = new _DeviceListModel2.default();
    this.init();
  }
  ...
  _createClass(AppController, [{
    ...
    value: function init() {
      ...
      (0, _jquery2.default)('#addDeviceForm').submit(function (event) {
        event.preventDefault();
        _this.addDevice();
      });
    ...
    value: function addDevice() {
      ...
      this.appService.addDevice(AppController.getDeviceForm()).then(function (res) {
        _this2.getDevices();
      }).catch(function (err) {
        console.log(err);
      });
    ...
    value: function getDevices() {
      ...
      this.appService.getDevices().then(function (res) {
        res.forEach(function (item) {
          _this3.deviceListModel.addDevice(new _DeviceModel2.default(item));
        });
        _this3.deviceListView.update(_this3.deviceListModel.List);
      }).catch(function (err) {
        console.log(err);
      });
    }
    ...
    key: 'getDeviceForm',
    value: function getDeviceForm() {
      var form = document.querySelector('#addDeviceForm');
    ...
    key: 'checkTrueOrFalse',
    value: function checkTrueOrFalse(data) {
      return data === 'yes';
    }
  }]);
...
},{"../model/DeviceListModel":4,"../model/DeviceModel":5,"../service/AppService":6,"../view/DeviceListView":7,"jquery":1}],4:[function(require,module,exports){
"use strict";
...
var DeviceListModel = function () {
  function DeviceListModel() {
    _classCallCheck(this, DeviceListModel);

    this.list = [];
  }

  _createClass(DeviceListModel, [{
    key: "addDevice",
...
exports.default = DeviceListModel;
...
var DeviceListView = function () {
  function DeviceListView(elem) {
    _classCallCheck(this, DeviceListView);

    this.elem = (0, _jquery2.default)(elem);
  }

  _createClass(DeviceListView, [{
    key: 'update',
...
exports.default = DeviceListView;
